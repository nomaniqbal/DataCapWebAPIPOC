...
{
    public static class IsoMsgBuilder
    {
        ...
        /// <summary>
        /// Build the Base64 encoded Auth Msg
        /// </summary>
        /// <returns></returns>
        public static AuthCRequestBE GetAuthMsg()
        {
            // just a simple stub for testing
            return new AuthCRequestBE(ISO8583_BASE64);
        }
